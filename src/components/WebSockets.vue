        ...
        <div class="col-md-6">
          <form class="form-inline">
            <div class="form-group">
              <label for="connect">WebSocket StoreJS:</label>
      ...
      <div class="row">
        <div class="col-md-12">
          <table id="conversation" class="table table-striped">
            ...
            <tbody>
            <tr v-for="(item, index) in this.$store.state.received_messages" :index="index" :key="index">
              <td>{{ item.target }} was followed by {{ item.sender }}</td>
            </tr>
            </tbody>
          </table>
        </div>
